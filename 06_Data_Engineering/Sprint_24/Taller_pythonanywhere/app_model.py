...
def home():
    return 'Bienvenido a mi API advertisement'
...
def retrain():  # Rutarlo al endpoint '/api/v1/retrain/', metodo GET
    if os.path.exists('data/Advertising_new.csv'):
        ...
        X_train, X_test, y_train, y_test = train_test_split(data.drop(columns = ['sales']), data['sales'], test_size = 0.20, random_state = 42)
