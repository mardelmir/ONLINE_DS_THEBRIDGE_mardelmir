...
@app.route('/api/v1/resources/book', methods = ['GET'])           # URL .../book?id=1    # Query string
def api_id():
...
# Jupyter notebook
@app.route('/api/v2/resources/book', methods = ['GET'])       # Json
def get_by_id():
...
@app.route('/api/v2/resources/book', methods = ['POST'])
def post_book():
